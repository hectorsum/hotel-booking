export default class Horizontal_BookingRH {
  constructor({
    ...
    if (tabs && tabs['HA'] && tabs['HA'].promocode && tabs['HA'].agencygroup &&
      ...
      this.setPromoCode('HA')
      this.setAgencyGroup('HA')
      this.setPromoCode('HO')
      this.setAgencyGroup('HO')
  ...
  init() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
      // Setting Active Tabs
      let tabsselector = document.querySelectorAll(".tabs-rh-h li a");
      tabsselector.forEach((elem, idx) => {
        elem.addEventListener('click', () => {
          if (elem.classList.contains('active-tab-rh-H')) return false;
          elem.className += ' active-tab-rh-H';
          if (elem.classList.contains('tab1')) {
            document.getElementById('body-tab-HA-h').className += ' show-active-tab-h';
            document.getElementById('body-tab-HO-h').classList.remove('show-active-tab-h');
          } else if (elem.classList.contains('tab2')) {
            document.getElementById('body-tab-HO-h').className += ' show-active-tab-h';
            document.getElementById('body-tab-HA-h').classList.remove('show-active-tab-h');
          }
          tabsselector.forEach((ell, idy) => {
            if (idx !== idy) {
              ell.classList.remove('active-tab-rh-H');
            }
          })
        })
      })
      ...
      if (this.tabs && this.tabs['HO'].checkinout) {
        ...
        const btncheckinout2 = document.querySelector('.body-tab-HO-h .check-in-out');
  ...
  setButton(tabInitials) {
    ...
    buttonDiv.className = 'col-lg-12 mt-3 btn-wrapper-rh-h';
    buttonDiv.innerHTML = `
  ...
  setDefaultTab() {
    const widget = document.getElementById('widget-rh-h');
    let tabDiv = document.createElement('ul');
    tabDiv.className = 'tabs-rh-h';
    tabDiv.innerHTML = `
      <li>
        <a class="tab1 active-tab-rh-H" href="#">HOTEL + AIR</a>
      </li>
    `;
  ...
  setBothTabs() {
    ...
    bodyHA.className = 'form-input d-flex col-lg-12 row m-0 body-tab-HA-h show-active-tab-h';
    bodyHA.setAttribute('id', 'body-tab-HA-h');
    bodyHA.innerHTML = `
      <form class="d-flex col-lg-12 row p-0 m-0" name="myform_HA_h" id="myform_HA_h" action="https://www.reservhotel.com/miami-united-states/test-hotel/booking-engine/ibe5.main"
    ...
    `;
    bodyHO.className = 'form-input d-flex col-lg-12 row m-0 body-tab-HO-h';
    bodyHO.setAttribute('id', 'body-tab-HO-h');
    bodyHO.innerHTML = `
      <form class="d-flex col-lg-12 row p-0 p-0 m-0" name="myform_HO_h" id="myform_HO_h" action="https://www.reservhotel.com/miami-united-states/test-hotel/booking-engine/ibe5.main"
  ...
  setHOTab() {
    ...
    tabDiv.innerHTML = `
    <li>
      <a class="tab2 active-tab-rh-H" href="#">HOTEL ONLY</a>
    </li>
    `;
    widget.appendChild(tabDiv);
    let bodyHO = document.createElement('div');
    bodyHO.setAttribute('id', 'body-tab-HO-h');
    bodyHO.className = 'form-input d-flex col-lg-12 row p-0 m-0 body-tab-HA-h show-active-tab-h';
    //setting up the modal which is related to the datepicker
    bodyHO.innerHTML = `
      <form class="d-flex col-lg-12 row m-0" name="myform_HO_h" id="myform_HO_h" action="https://www.reservhotel.com/miami-united-states/test-hotel/booking-engine/ibe5.main"
  ...
  setCheckInOut(tabInitials) {
    ...
    checkinoutDiv.className = 'check-in-out col-sm-12 col-lg-4';
  ...
  setAdults(tabInitials) {
    ...
    if (tabInitials === 'HO') {
      adultsDiv.className = 'dropdown__field col-lg-2';
    } else {
      adultsDiv.className = 'dropdown__field col-lg-2 p-0';
    }
    ...
    <div class="selectdiv">
      <label>
        <select name="adults" id="adults-${tabInitials}-h">
  ...
  setChildren(tabInitials) {
    ...
    if (tabInitials === 'HO') {
      childrenDiv.className = 'dropdown__field col-lg-2';
    } else {
      childrenDiv.className = "dropdown__field col-lg-2 p-0";
    }
    childrenDiv.innerHTML = `
      ...
      <div class="selectdiv">
        <label>
          <select name="child" id="children-${tabInitials}-h">
  ...
  setAirport(tabInitials = 'HA') {
    ...
    airportDiv.className = "col-lg-4 p-0 aiport-wrapper-h"
    airportDiv.setAttribute('required', true)
  ...
  setHotelDropdown(tabInitials) {
    ...
    let childrenDiv = document.createElement("div")
    if (tabInitials === 'HO') {
      childrenDiv.className = "dropdown__field col-lg-4";
    } else {
      childrenDiv.className = "dropdown__field col-lg-4";
    }
    ...
    childrenDiv.innerHTML = `
      ...
      <div class="selectdiv">
        <label>
          <select name="hotel" id="hotels-${tabInitials}-h">
          </select>
        </label>
      </div>
    `;
